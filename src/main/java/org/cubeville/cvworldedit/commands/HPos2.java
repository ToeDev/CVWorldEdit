...
public class HPos2 extends Command {

    final private String prefix;

    public HPos2(CVWorldEdit plugin) {
        super("");
    ...
    public CommandResponse execute(Player sender, Set<String> set, Map<String, Object> map, List<Object> baseParameters) {
        ...
        if (baseParameters.size() > 0) {
            return new CommandResponse(prefix + ChatColor.RED + "Invalid Command!" + ChatColor.LIGHT_PURPLE + " Proper Usage: /wehpos2");
        }
        ...
        Location pos = bPlayer.getBlockTrace(300);
        if(pos == null) return new CommandResponse(prefix + ChatColor.RED + "No block found within 300 blocks!");
