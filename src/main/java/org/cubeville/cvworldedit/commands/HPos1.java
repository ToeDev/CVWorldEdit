...
public class HPos1 extends Command {

    final private String prefix;

    public HPos1(CVWorldEdit plugin) {
        super("");
    ...
    public CommandResponse execute(Player sender, Set<String> set, Map<String, Object> map, List<Object> baseParameters) {
        ...
        if (baseParameters.size() > 0) {
            return new CommandResponse(prefix + ChatColor.RED + "Invalid Command!" + ChatColor.LIGHT_PURPLE + " Proper Usage: /wehpos1");
        }
